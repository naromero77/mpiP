...
void mpiPi_stats_mt_cs_gather(mpiPi_mt_stat_t *mt_state, int *ac,
                              callsite_stats_t ***av) {
...
void mpiPi_stats_mt_cs_upd(mpiPi_mt_stat_tls_t *hndl, unsigned op,
  ...
  mpiPi_stats_thr_cs_upd(hndl->tls_ptr, op, rank, pc, dur, sendSize, ioSize,
                         rmaSize);
}
...
void mpiPi_stats_mt_coll_binstrings(mpiPi_mt_stat_t *stat, int comm_idx,
                                    ...
                                    char *size_buf) {
  mpiPi_stats_thr_coll_binstrings(&stat->rank_stats, comm_idx, comm_buf,
                                  size_idx, size_buf);
}
